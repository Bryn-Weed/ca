...
<div id="service" class="bg-1">
  ...
  <div class="row text-center">
      ...
      <div class="thumbnail">;
          ...
          <img src="serviceimages/1.jpg" alt="" width="400" height="300">;

        <p><strong>Dog Walking</strong></p>;
        <p>£10 per hour</p>';
      <a data-toggle="collapse" class="btn1" data-target="#data1">  <span class="glyphicon glyphicon-chevron-down"></span></a>';
        <div id="data1" class="collapse">;
        <p>-----</p>;
        <p class="ex1">Dog walk in a local park or field. 30 minutes or 1 hour walks available.</p>;
          <button class="btn1" data-toggle="modal" data-target="#myModal">Request</button>;
        </div>;
        </div>;
        ...
        <div class="thumbnail">;
            ...
            <img src="serviceimages/2.jpg" alt="" width="400" height="300">;

          <p><strong>Dog Sitting</strong></p>;
          <p>£15 per hour</p>';
        <a data-toggle="collapse" class="btn1" data-target="#data2">  <span class="glyphicon glyphicon-chevron-down"></span></a>';
          <div id="data2" class="collapse">;
          <p>-----</p>;
          <p class="ex1">Dog sitting at your home or ours!</p>;
            <button class="btn1" data-toggle="modal" data-target="#myModal">Request</button>;
          </div>;
          </div>;
          ...
          <div class="thumbnail">;
              ...
              <img src="serviceimages/3.jpg" alt="" width="400" height="300">;

            <p><strong>Dog Training</strong></p>;
            <p>£20 per hour</p>';
          <a data-toggle="collapse" class="btn1" data-target="#data3">  <span class="glyphicon glyphicon-chevron-down"></span></a>';
            <div id="data3" class="collapse">;
            <p>-----</p>;
            <p class="ex1">Certified and professional dog trainer available.</p>;
              <button class="btn1" data-toggle="modal" data-target="#myModal">Request</button>;
            </div>;
            </div>;
        </div>;
